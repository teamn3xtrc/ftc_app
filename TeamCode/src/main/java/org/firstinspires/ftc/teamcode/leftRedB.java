...
@Autonomous(name = "Red 1B", group = "agroup")

public class leftRedB extends LinearOpMode
{
    //constants
    ...
    static final int DEGREES_180 = 4850;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(((colorSensor.blue()+colorSensor.blue())/2)>=100)
        {
            SwayRight(700);
            BeaconServo.setPosition(0);
...
/*
    ...
    public static void AxisRight(int degreeval)
    {
        motorBackLeft.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        motorFrontLeft.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        motorBackRight.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
    ...
    public static void AxisLeft(int degreeval)
    {
        motorBackLeft.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        motorFrontLeft.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        motorBackRight.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
